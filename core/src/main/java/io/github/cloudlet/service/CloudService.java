...
public class CloudService {
    ...
    public void update(Cloud cloud, float delta, Biome biome) {
        float drainMult = (biome != null) ? biome.getWaterDrainMultiplier() : 1f;
        cloud.consumeWater(GameConstants.Cloud.WATER_DRAIN_PER_SEC * drainMult * delta);
        updateSize(cloud);
